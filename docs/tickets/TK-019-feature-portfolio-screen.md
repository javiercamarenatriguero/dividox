...
- [x] **Create Git Branch** `feature/DVX-TK-019-feature-portfolio-screen` — `skill: manage-git-flow`

### Phase 2: Scaffold
- [x] **Scaffold `:feature:portfolio`**
...
- [x] **`PortfolioViewModel`** + unit tests
...
- [x] **Wire `PortfolioRoute` in `mainGraph`**
- [x] **Register `:feature:portfolio` Koin module** in `App.kt` startKoin
